...
### 5. Transactional movement data (e.g order, deliveries, purchase orders)
...
### 3. Recommended reference fields
...
"position": string length ≤ 200; extual information about the job position of an individual.
